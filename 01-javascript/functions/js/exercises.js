...
const f1 = tellFortune(6, 'Sidney', 'Paris', 'chalk artist');
console.log( f1 );

const f2 = tellFortune(7, 'Georgia', 'South London', 'rare book dealer');
console.log( f2 );

const f3 = tellFortune(5, 'Jonesy', 'Liverpool', 'window washer');
console.log( f3 );
...
const calculateDogAge = function (age, humanToDogsYearsRatio=7) {
  const message = `Your doggie is ${ age * humanToDogsYearsRatio } years old in dog years!`;
  return message;
};

console.log( calculateDogAge(5) );
console.log( calculateDogAge(2, 9) );
