...
// const eUsers = _(people).filter(function (u) {
//   return u.username === 'E';
// });
...
const user3 = _(people).findWhere({id: 3}); // returns the first value.
console.log( user3 );
...
const youngster = _(people).find(youngPerson); // returns a single element.
...
console.table( adults ); // everyone should be over 60.
